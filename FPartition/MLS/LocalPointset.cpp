...
double LocalPointset::calc_Correlation_LP(double H){
    ...
    move_OriginOfCoordinateSystem_ToOriginPoint();// 邻域局部相对坐标
...
void LocalPointset::project_LP_OntoWLSPlane(){
    ...
    rotate_Pointset_parallelToXY();// 旋转平面和点云与z轴垂直
...
void LocalPointset::calc_WLS_QuadraticCurve(){
    ...
    sum_X4W = sum_X3W = sum_X2W = sum_XW = sum_X2YW = sum_XYW = sum_YW = sum_W=0.0;
